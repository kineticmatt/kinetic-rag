...
export default async function adminRoutes(app) {
    ...
    app.post("/admin/tenant", async (req, reply) => {
        ...
        const r = await pool.query(`insert into tenants (slug, name) values ($1, $2) returning id, slug, name`, [slug, name]);
        reply.send(r.rows[0]);
    });
    ...
    app.post("/admin/keys", async (req, reply) => {
        ...
        const r = await pool.query(`insert into api_keys (id, tenant_id, name, key_hash) values ($1, $2, $3, $4)
    ...
    app.get("/admin/keys", async (req, reply) => {
        ...
        const r = await pool.query(`select id, tenant_id, name, created_at, revoked_at from api_keys
